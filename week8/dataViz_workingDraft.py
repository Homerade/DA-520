...
#-----------Oct 31---------------
# txt = "1820"
# font = date1.getsize(text)*100

# year = data.get(key[3])
# year = (data[0]['year'])
# yearEndNum = (data[0]['year'][3])
...
for line in data:
	...
	# yearEndNum = (line['year'][3])
	# if yearEndNum == 5
	# 	draw.text( (x+20,y), year, fill=(0), font=font)
...
# draw.text( (500,180),"1820", fill=(0), font=font)

# draw.text( (lat+100, lon), '1830', fill=(0), font=font)
# # draw.line( (lat,lon,lat+100,lon+100), fill=(0), width=2)



# draw.text( ((lat+200), (lon+100)), '1840', fill=(0), font=font)
# draw.text( ((lat+300), (lon+200)), '1850', fill=(0), font=font)
# draw.text( ((lat+400), (lon+300)), '1860', fill=(0), font=font)
...
# draw.text( ((lat+1000), (lon+900)), '1920', fill=(0), font=font)
# draw.text( ((lat+1100), (lon+1000)), '1930', fill=(0), font=font)
# draw.text( ((lat+1200), (lon+1100)), '1940', fill=(0), font=font)
# draw.text( ((lat+1300), (lon+1200)), '1950', fill=(0), font=font)

# draw.text( (1930,1600),'1962', fill=(0), font=font)

draw.line( (100,100,900,900), fill=0, width=3 )
